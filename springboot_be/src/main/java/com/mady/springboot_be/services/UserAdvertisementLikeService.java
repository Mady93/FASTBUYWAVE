 ...
 * 
 * Like operations are idempotent: multiple like requests do not create
 * duplicates.
 * 
...
public interface UserAdvertisementLikeService {
      ...
      *         - data: List&lt;LikeStatusDto&gt; (list of advertisement IDs with
      *         liked status)
      */
      ...
      *         - data: List&lt;LikeUserDTO&gt; (list of user details with like
      *         timestamp)
      */
